...
public class Uc_Detail {
	private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Uc_Detail.class);
	...
	String osPlatformString=page.getHtml().xpath("//div[@class='title-stat']/div[2]/ul/li[5]/text()").toString();
	...
	appDescription = page.getHtml().xpath("//div[@class='conTxt']/text()").toString();

...
public class Zhuannet implements PageProcessor{
	...
	public Apk process(Page page) {
		...
		List<String> urls =page.getHtml().links().regex("http://apk\\.zhuannet\\.com/.*").all() ;
		...
		//提取页面信息
		if(page.getUrl().regex("http://apk\\.zhuannet\\.com/soft/.+").match() 
				|| page.getUrl().regex("http://apk\\.zhuannet\\.com/game/.+").match()){

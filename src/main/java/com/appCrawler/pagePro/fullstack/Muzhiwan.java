...
public class Muzhiwan implements PageProcessor{
	...
	public Apk process(Page page) {
		...
		List<String> urls =page.getHtml().links().regex("http://www\\.muzhiwan\\.com/.*").all() ;
		...
		for (String temp : cacheSet) {
			...
			if(!temp.contains("?action=common&opt=downloadstat")&&PageProUrlFilter.isUrlReasonable(temp))
						page.addTargetRequest(temp);
		}
		
	
		//提取页面信息
		if(page.getUrl().regex("http://www\\.muzhiwan\\.com/.*").match()){

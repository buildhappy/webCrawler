...
public class Mgapp implements PageProcessor{
	...
	private Logger LOGGER = LoggerFactory.getLogger(Mgapp.class);

	public Apk process(Page page) {
	
		//System.out.println(page.getHtml().toString());
		List<String> urls =page.getHtml().links().regex("http://www\\.mgyapp\\.com/.*").all() ;
...
//		page.addTargetRequests(urls);
		...
		//提取页面信息
		if(page.getUrl().regex("http://www\\.mgyapp\\.com/apps.*").match()){
